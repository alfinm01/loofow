            ...
            <div class="box">
                <div class="field has-addons">
                    <div class="control is-expanded">
                        <input class="input has-text-centered" type="search" placeholder="Cari Barangmu...">
                    </div>
                    <div class="control">
                        <a class="button is-info">Cari</a>
                    </div>
                </div>
            </div>
            <!-- Developers -->
                        ...
                        <div class="card-content">
                            <div class="media">
                                ...
                                <div class="media-content">
                                    <p class="title is-4 no-padding">Barang 1</p>
                                    <p><span class="title is-6"><a href="http://twitter.com/#">@twitterid</a></span></p>
                                    <p class="subtitle is-6">Model X</p>
                                </div>
                            </div>
                            <div class="content">
                    ...
                    <div class="card large">
                        ...
                        <div class="card-content">
                            <div class="media">
                                ...
                                <div class="media-content">
                                    <p class="title is-4 no-padding">Barang 2</p>
                                    <p><span class="title is-6"><a href="http://twitter.com/#">@twitterid</a></span></p>
                                    <p class="subtitle is-6">Model Y</p>
                                </div>
                            </div>
                            <div class="content">
                    ...
                    <div class="card large">
                        ...
                        <div class="card-content">
                            <div class="media">
                                ...
                                <div class="media-content">
                                    <p class="title is-4 no-padding">Barang 3</p>
                                    <p><span class="title is-6"><a href="http://twitter.com/#">@twitterid</a></span></p>
                                    <p class="subtitle is-6">Model Z</p>
                                </div>
                            </div>
                            <div class="content">
